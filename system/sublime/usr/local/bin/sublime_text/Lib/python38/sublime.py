...
class Window:
    ...
    def new_html_sheet(self, name: str, contents: str, flags = NewFileFlags.NONE, group = -1) -> Sheet:
        ...
        :param name: The HTML contents of the sheet.
...
class Selection:
    ...
    def __eq__(self, rhs: Optional[Selection]) -> bool:
...
class ContextStackFrame:
    ...
    def __init__(self, context_name, source_file, source_location):
        ...
        self.source_location: (int, int) = source_location
        """
...
class View:
    ...
    def show(self, location: Union[Region, Selection, Point], show_surrounds=True, keep_to_left=False, animate=True):
        """
    ...
    def show_popup(self, content: str, flags=PopupFlags.NONE, location: Point = -1,
        ...
        :param location: The `Point` at which to display the popup. If ``-1``
                         the popup is shown at the mouse cursor.
...
class CompletionList:
    ...
    def set_completions(self, completions: [CompletionValue], flags=AutoCompleteFlags.NONE):
        """
...
class CompletionItem:
    ...
    def __init__(
        ...
        .. since:: 4073
        """
        self.flags = CompletionItemFlags.NONE
...
class QuickPanelItem:
    ...
    def __init__(self, trigger, details="", annotation="", kind=KIND_AMBIGUOUS):
        ...
        self.details: Union[str, List[str], Tuple[str]] = details
        """
